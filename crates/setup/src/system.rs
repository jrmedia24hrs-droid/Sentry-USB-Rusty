...
# (hyper, h2, tokio, axum) stays at warn so journald isn't flooded
# with framework-level logs that nobody reads. Result: less write IO
# to the SD card, smaller journal footprint, less per-log CPU on Pi
# Zero 2W.
